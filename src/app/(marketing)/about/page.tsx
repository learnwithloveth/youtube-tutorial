...
export const metadata: Metadata = {
  title: 'About',
  description:
    'Why we rebuilt the matching engine, who we are, and what we will not compromise on.',
};
  ...
  return (
    <>
      <PageHero
        ...
        actions={
          <>
            <ButtonLink href="/careers" size="lg" sheen>
              See open roles
      ...
      <CtaBand
        ...
        secondary={{ label: 'Press enquiries', href: '/press' }}
      />
    </>
  );
}
