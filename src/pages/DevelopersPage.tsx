...
import { CodeBlock, type CodeTab } from '@/components/visuals/CodeBlock';
import { StaggerGroup, StaggerItem, Reveal } from '@/design-system/motion/Reveal';
...
export default function DevelopersPage() {
  useSeo({
    ...
    description:
      'REST for state, WebSocket for streams, FIX 4.4 for desks. Idempotent writes, cursor pagination and 90-day deprecation windows.',
  });
      ...
      <PageHero
        ...
        actions={
          <>
            ...
            <ButtonLink to="/institutional" variant="outline" size="lg">
              FIX connectivity
            </ButtonLink>
          </>
        }
