...
const SUGGESTIONS = [
  { icon: TrendingUp, label: 'Live markets', description: 'Prices for 340+ assets', to: '/markets' },
  { icon: Home, label: 'Home', description: 'Start from the beginning', to: '/' },
  { icon: LifeBuoy, label: 'Help', description: 'Talk to a human', to: '/contact' },
];

export default function NotFoundPage() {
  useSeo({
    title: 'Page not found',
    description: 'That page does not exist on Novex.',
    noindex: true,
  });
      ...
      <div className="shell text-center">
        ...
        <Reveal delay={0.18}>
          <div className="mt-10 flex flex-wrap justify-center gap-3">
            <ButtonLink to="/" size="lg" sheen>
              Back to home
              <ArrowRight className="size-4 transition-transform duration-300 group-hover:translate-x-1" />
            </ButtonLink>
            <ButtonLink to="/markets" variant="outline" size="lg">
              View markets
            </ButtonLink>
          </div>
        </Reveal>
