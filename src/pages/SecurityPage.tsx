...
export default function SecurityPage() {
  useSeo({
    ...
    description:
      '98% cold storage, daily Merkle proof-of-reserves, a $250M insurance fund and 14 regulatory licences. Every claim here is one you can verify.',
  });
      ...
      <PageHero
        ...
        actions={
          <>
            ...
            <ButtonLink to="/status" variant="outline" size="lg">
              System status
            </ButtonLink>
          </>
        }
            ...
            <Card className="overflow-hidden p-8 md:p-12">
              <div className="grid gap-10 lg:grid-cols-[1.1fr_1fr] lg:items-center">
                <div>
                  ...
                  <ButtonLink to="/signup" variant="outline" className="mt-8">
        ...
        <div className="shell">
          ...
          <Reveal>
            <Card className="mt-6 flex flex-wrap items-center justify-between gap-6 p-7">
              ...
              <ButtonLink to="/legal/terms" variant="outline" size="sm">
                Read the terms
              </ButtonLink>
            </Card>
          </Reveal>
