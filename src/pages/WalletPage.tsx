...
export default function WalletPage() {
  useSeo({
    title: 'Novex Wallet — self-custody',
    description:
      'Self-custody with MPC key shards across three regions. No seed phrase, 32 networks, and free instant transfers to and from your exchange account.',
  });
  ...
  return (
    <>
      <PageHero
        ...
        actions={
          <>
            <ButtonLink to="/app" size="lg" sheen>
              Download the wallet
              <ArrowRight className="size-4 transition-transform duration-300 group-hover:translate-x-1" />
            </ButtonLink>
            <ButtonLink to="/security" variant="outline" size="lg">
              How the keys work
            </ButtonLink>
          </>
        }
      ...
      <CtaBand
        ...
        secondary={{ label: 'Read the security model', to: '/security' }}
      />
    </>
  );
}
