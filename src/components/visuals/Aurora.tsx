 ...
 * clipped to the section. Purely decorative — never announced to AT.
 */
export function Aurora({ className, grid = false }: { className?: string; grid?: boolean }) {
  return (
    <div aria-hidden className={cn('pointer-events-none absolute inset-0 -z-10 overflow-hidden grain', className)}>
