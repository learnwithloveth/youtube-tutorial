        ...
        >
          <div className="shell flex min-h-full flex-col gap-6 py-8">
                      ...
                      {isOpen ? (
                        ...
                        >
                          <div className="grid gap-1 pb-5">
                            {column.groups?.flatMap((g) => g.items).map((item) => (
                              <Link
            ...
            <div className="mt-auto grid gap-3">
              <ButtonLink to="/signup" size="lg" sheen onClick={onClose}>
                Create free account
              </ButtonLink>
              <div className="flex items-center gap-3">
                <ButtonLink to="/login" variant="outline" size="lg" className="flex-1" onClick={onClose}>
                  Log in
                </ButtonLink>
