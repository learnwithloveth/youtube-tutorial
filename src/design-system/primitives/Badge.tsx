...
const TONES: Record<BadgeTone, string> = {
  brand: 'text-brand-soft bg-[color-mix(in_oklab,var(--brand)_16%,transparent)] border-[color-mix(in_oklab,var(--brand)_36%,transparent)]',
  accent: 'text-accent bg-[color-mix(in_oklab,var(--accent)_14%,transparent)] border-[color-mix(in_oklab,var(--accent)_34%,transparent)]',
