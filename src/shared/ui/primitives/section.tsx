 ...
 *
 * Both are Server Components. `SectionHeading` renders `<Reveal>` — a Client
 * Component — but passes its own server-rendered markup through as children, so
 * the heading text ships as HTML and only the animation wrapper hydrates.
 */
