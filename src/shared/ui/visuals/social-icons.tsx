 ...
 *
 * The design took these from `lucide-react`, which dropped its brand icons in
 * v1 — correctly, since a company's mark is not a UI glyph and should not drift
 * with an icon set's redraws. Inlining the four paths pins them, costs no
 * dependency, and keeps them accurate; each is a single path from the
 * respective brand's own published mark.
 */
